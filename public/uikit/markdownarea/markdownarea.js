...
(function(addon) {
    ...
    Markdownarea.defaults = {
        ...
        "lblPreview"   : "<i class='unhide icon'></i>",
        "lblCodeview"  : "<i class='code icon'></i>"
    };
                                ...
                                '<div class="uk-markdownarea-navbar">' +
                                    ...
                                    '<div class="uk-markdownarea-navbar-flip">' +
                                        '<ul class="uk-markdownarea-navbar-nav">' +
                                            '&nbsp;<a id="save" class="ui small teal button">Save</a>&nbsp;'+
                                            '<a id="publish" class="ui small button teal">Publish</a>&nbsp;'+
                                            '<li class="uk-markdown-button-markdown"><a data-uk-tooltip title="Markdown">{:lblCodeview}</a></li>' +
                                            '<li class="uk-markdown-button-preview"><a data-uk-tooltip title="Preview">{:lblPreview}</a></li>' +
                                            '<li><a data-markdownarea-cmd="fullscreen" data-uk-tooltip title="Fullscreen"><i class="uk-icon-expand"></i></a></li>' +
                                        '</ul>' +
                                    '</div>' +
                                '</div>' +
